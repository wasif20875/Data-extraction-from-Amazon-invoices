...
filelist=[]
index1=[]
directory='F:\Text Books\Business Analytics\MG241 Marketing Management\Invoices\Siddarth_text'
...
print(df)
df.to_csv('F:\Text Books\Business Analytics\MG241 Marketing Management\Invoices\\experiment.csv')
